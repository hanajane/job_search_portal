...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $qresult= $db->select($sqlemail);
    $count = mysqli_num_rows($qresult);

    if($count > 0)
    {
        $_SESSION['message'] = "<div class=\"sessionMessage\"> This email address is already registered. Click <a href=\"login.php\">here </a> to login </div>";
		}
		else
		{
